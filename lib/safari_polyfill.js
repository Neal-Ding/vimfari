...
if (_safariDetected) {
  ...
  // ---- chrome.sessions.MAX_SESSION_RESULTS default ----
  // Safari may support chrome.sessions but with different limits.
  if (chrome.sessions && !chrome.sessions.MAX_SESSION_RESULTS) {
